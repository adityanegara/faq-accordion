...
import backgroundImageDesktop from "../../../assets/images/bg-pattern-desktop.svg";
...
const FaqAccordion = () =>{
    return(
        <Container>
            <Card  backgroundImageDesktop={backgroundImageDesktop} backgroundImageMobile={backgroundImageMobile}>
